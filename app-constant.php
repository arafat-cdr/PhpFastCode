...
# statically set the $app_url Because Certain serer have issue..

define('APP_URL', 'http://localhost/PhpFastCode');
...
define("PUBLIC_URL", str_replace("/index.php", "", APP_URL).$public);
